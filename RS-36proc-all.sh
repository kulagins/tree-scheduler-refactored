...
echo "matrix"
pwd
./main ./real_Trees/trees/ treesListNoBiggest.txt ./clusters/36-proc/36proc_0,5-1-1,5-3.json 0 0 0   
for cluster in $clusters; do 
    echo "!! $cluster"
    ./main ./real_Trees/trees/ treesListNoBiggest.txt ./clusters/36-proc/$cluster 0 1 0      
done


echo "normal random"
 ./main ./real_Trees/random_trees/old_trees/ treesList.txt ./clusters/36-proc/36proc_0,5-1-1,5-3.json 0 0 0   
for cluster in $clusters; do 
    echo "!! $cluster"
    ./main ./real_Trees/random_trees/old_trees/ treesList.txt ./clusters/36-proc/$cluster 0 1 0   
done
