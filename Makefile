...
CFLAGS = $(WARNINGS) -m64 -O3 -g -DNOASSERT -std=c++14 -fopenmp
INCLUDES = -I${INC_PATH}
DEFS = 
LDADD =
...
heuristics.o: src/heuristics.cpp include/heuristics.h lib-io-tree-minmem.o lib-io-tree-liu-optimal.o lib-io-tree.o
	$(CPP) $(INCLUDES) $(DEFS) $(CFLAGS) -o ${OBJ_PATH}/$@ -c $< -fPIC


heuristics:heuristics.o
	rm -f ${LIB_PATH}/$@.a ${LIB_PATH}/$@.so
	ar rcs ${LIB_PATH}/$@.a $(OBJ_PATH)/heuristics.o $(OBJ_PATH)/lib-io-tree.o $(OBJ_PATH)/lib-io-tree-utils.o $(OBJ_PATH)/lib-io-tree-minmem.o $(OBJ_PATH)/lib-io-tree-liu-optimal.o
